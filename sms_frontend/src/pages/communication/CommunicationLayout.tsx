...
const navItems = [
  { label: 'Dashboard', to: '/modules/communication/dashboard' },
  { label: 'Conversations', to: '/modules/communication/messaging' },
  { label: 'Notifications', to: '/modules/communication/notifications' },
  { label: 'Email Manager', to: '/modules/communication/email' },
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-12 gap-4 px-4 py-6 sm:gap-6 sm:px-6 sm:py-8">
        <aside className="col-span-12 rounded-2xl glass-panel p-5 md:col-span-3 lg:col-span-2">
          <ModuleToolbar currentModule="COMMUNICATION" />
          <p className="text-xs uppercase tracking-[0.3em] text-slate-400">Communication</p>
